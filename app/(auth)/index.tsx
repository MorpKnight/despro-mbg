  ...
  if (Platform.OS !== 'web') {
    return (
      <View className="flex-1 bg-neutral-gray p-6 gap-4 justify-center">
        ...
        {error ? <Text className="text-red-500 text-body text-center">{error}</Text> : null}
        <TextInput placeholder="Username" value={username} onChangeText={(t) => { setUsername(t); if (usernameError) setUsernameError(null); }} autoCapitalize="none" />
        <TextInput placeholder="Password" value={password} onChangeText={(t) => { setPassword(t); if (passwordError) setPasswordError(null); }} secureTextEntry />
        <Button
        ...
        <View className="items-center mt-2">
          <Text className="text-gray-500 text-xs">Try: super/super123, sekolah/sekolah123, catering/catering123, siswa/siswa123, dinkes/dinkes123</Text>
        </View>
      </View>
    );
  }
        ...
        <View className="flex-1 items-center justify-center p-6">
          <View className="w-full max-w-md bg-neutral-white rounded-card shadow-card p-8">
            <View className="items-center mb-6">
              ...
              <Text className="text-gray-500 mt-1">Please sign in to your account</Text>
            </View>
            ...
            <View className="gap-3">
              <View>
                ...
                <TextInput placeholder="Enter your username" value={username} onChangeText={(t) => { setUsername(t); if (usernameError) setUsernameError(null); }} autoCapitalize="none" />
                {usernameError ? <Text className="text-red-600 text-xs mt-1">{usernameError}</Text> : null}
              </View>
              <View>
                <Text className="text-sm text-gray-700 mb-1">Password</Text>
                <View className="relative">
                  <TextInput placeholder="••••••••" value={password} onChangeText={(t) => { setPassword(t); if (passwordError) setPasswordError(null); }} secureTextEntry={!showPassword} />
            ...
            <View className="items-center mt-4">
              <Text className="text-gray-400 text-xs text-center">
                Demo accounts: super/super123 · sekolah/sekolah123 · catering/catering123 · siswa/siswa123 · dinkes/dinkes123
              </Text>
            </View>
          </View>
        </View>
