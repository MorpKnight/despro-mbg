...
const translations = {
  id: {
    ...
    'network.sectionTitle': 'Mode Jaringan',
    'network.localToggle': 'Gunakan Server Lokal',
    'network.modeValue.local': 'Lokal',
    'network.modeValue.cloud': 'Cloud',
    'network.localIpLabel': 'Alamat IP Server Lokal',
    'network.localIpPlaceholder': 'Contoh: 192.168.0.10',
    'network.localIpDescription': 'Perangkat akan mengirim data ke server Raspberry Pi pada jaringan sekolah. Pastikan alamat ini dapat dijangkau.',
    'network.saveIpButton': 'Simpan IP Lokal',
    'network.requireIpAlertTitle': 'Setel IP Lokal',
    'network.requireIpAlertMessage': 'Masukkan alamat IP Raspberry Pi sebelum mengaktifkan Mode Lokal.',
    'network.saveSuccessTitle': 'IP Tersimpan',
    'network.saveSuccessMessage': 'Alamat IP lokal berhasil diperbarui.',
    'network.saveErrorTitle': 'Gagal Menyimpan IP',
    'network.toggleErrorTitle': 'Gagal Mengubah Mode',
    'network.toggleErrorMessage': 'Tidak dapat mengubah mode jaringan saat ini.',
  ...
  en: {
    ...
    'network.sectionTitle': 'Network Mode',
    'network.localToggle': 'Use Local Server',
    'network.modeValue.local': 'Local',
    'network.modeValue.cloud': 'Cloud',
    'network.localIpLabel': 'Local Server IP Address',
    'network.localIpPlaceholder': 'Example: 192.168.0.10',
    'network.localIpDescription': 'This device will send data to the Raspberry Pi server on the same network. Ensure the address is reachable.',
    'network.saveIpButton': 'Save Local IP',
    'network.requireIpAlertTitle': 'Set Local IP',
    'network.requireIpAlertMessage': 'Enter the Raspberry Pi IP address before enabling Local Mode.',
    'network.saveSuccessTitle': 'IP Saved',
    'network.saveSuccessMessage': 'Local IP address updated successfully.',
    'network.saveErrorTitle': 'Failed to Save IP',
    'network.toggleErrorTitle': 'Mode Switch Failed',
    'network.toggleErrorMessage': 'Unable to change network mode right now.',
